export const translations = {
  en: {
    ...
    about: {
      ...
      bio2: "Expert in the React ecosystem (React.js & React Native) and backend technologies like Node.js and Django, I deliver complete and scalable solutions from end to end.",
      ...
      exp2_desc: "End-to-end development of web and mobile applications using React, Django, and React Native.",
  ...
  fr: {
    ...
    about: {
      ...
      bio2: "Expert dans l'écosystème React (React.js & React Native) et les technologies backend comme Node.js et Django, je livre des solutions complètes et évolutives de bout en bout.",
      ...
      exp2_title: "Développeur Full-Stack (Freelance)",
      exp2_company: "Clients divers",
      exp2_desc: "Développement de bout en bout d'applications web et mobiles utilisant React, Django et React Native.",
