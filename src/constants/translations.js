export const translations = {
  en: {
    ...
    about: {
      ...
      exp2_company: "NGO Bussola",
      exp2_desc: "Design and implementation of web features, data flow automation, and user experience enhancements.",
      exp3_title: "Web & Mobile Developer",
      exp3_company: "UTC-services",
      exp3_desc: "Development of responsive interfaces, API integration, and application performance optimization.",
  ...
  fr: {
    ...
    about: {
      ...
      exp2_company: "ONG Bussola",
      exp2_desc: "Conception et implémentation de fonctionnalités web, automatisation de flux de données et amélioration de l'expérience utilisateur.",
      exp3_title: "Développeur Web & Mobile",
      exp3_company: "UTC-services",
      exp3_desc: "Développement d'interfaces responsives, intégration d'APIs et optimisation des performances applicatives.",
